...
const OffreJournee = () => {
  ...
  return (
    <OffreLayout
      ...
      metaDesc="Réservez votre journée à la Villa Maria : poste de travail, wifi fibre, café, piscine et boulodrome inclus. À partir de 35€/jour, réservation directe en ligne."
