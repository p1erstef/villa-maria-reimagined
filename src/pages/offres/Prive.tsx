...
const OffrePrive = () => {
  ...
  return (
    <OffreLayout
      offre={offre}
      metaTitle="Bureau privatif Bordeaux — Équipes 3 à 10 personnes — Villa Maria"
      metaDesc="Bureau privatif fermé pour votre équipe dans une villa Belle Époque à Bordeaux. De 3 à 10 personnes, tarif sur devis, tous services inclus."
      longIntro="Un bureau fermé rien qu'à votre équipe, dans une villa Belle Époque. C'est le siège qu'on vous enviera."
      idealPour={[
        "Startups en croissance (3 à 10 personnes)",
