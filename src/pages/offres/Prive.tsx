...
const OffrePrive = () => {
  ...
  return (
    <OffreLayout
      ...
      metaDesc="Bureau privatif fermé pour votre équipe dans une villa bourgeoise du XVIIIᵉ à Bordeaux. De 2 à 10 personnes, tarif sur devis, tous services inclus."
      longIntro="Un bureau fermé rien qu'à votre équipe, dans une villa du XVIIIᵉ. C'est le siège qu'on vous enviera."
      idealPour={[
