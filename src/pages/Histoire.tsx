...
const VALEURS = [
  {
    ...
    desc: "On croit qu'un beau bureau change la qualité du travail. Pas un slogan : un parti pris.",
  },
  {
    title: "Flexibilité",
    desc: "Pass d'un jour, mois, année — vos modalités, vos contraintes. On s'adapte.",
  },
  {
    title: "Communauté",
    desc: "Coworkers, événements, yoga, afterworks. Un lieu vivant, pas un open space froid.",
  },
  {
    title: "Bordeaux",
    desc: "Ancrés dans la ville, partenaires d'acteurs locaux, fiers de notre territoire.",
  },
];
        ...
        <div className="container-villa grid lg:grid-cols-[5fr_4fr] gap-12 items-center">
          <div>
            ...
            <p className="font-serif italic text-2xl text-muted-foreground">
              Au départ, dix amis. Une demeure bourgeoise. Une idée simple : et
              si on en faisait le plus beau bureau de France ?
            </p>
          </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="container-villa max-w-3xl prose prose-lg">
          <h2 className="font-display text-3xl uppercase mb-6">
            Pourquoi la Villa Maria.
          </h2>
          <p className="text-lg leading-relaxed text-foreground mb-5">
            <Placeholder>
              storytelling court et sincère à rédiger — 400 mots max
            </Placeholder>
            En attendant le texte définitif, l'histoire en quelques mots : dix
            associés bordelais, entrepreneurs et passionnés, ont repris une
            villa Belle Époque pour en faire un lieu hybride — coworking premium
            le jour, lieu d'événements le soir et le week-end.
          </p>
          <p className="text-lg leading-relaxed text-foreground mb-5">
          ...
          <p className="text-lg leading-relaxed text-foreground">
            ...
            , partenaire historique installé sur le site. Parce qu'un lieu de
            travail qui pense aux parents qui travaillent, c'est rare — et c'est
        ...
        <div className="container-villa">
          ...
          <div className="mb-10 max-w-3xl">
            <p className="text-sm text-muted-foreground bg-card border border-dashed border-border p-5 flex items-start gap-3">
              ...
              <span>
                En attendant les portraits individuels professionnels, retrouvez
                la photo de groupe ci-dessous. Chaque associé aura sa fiche
                dédiée prochainement.
              </span>
            </p>
          </div>
          ...
          <div className="aspect-[16/9] overflow-hidden mb-10 max-w-4xl">
            <img
              src={groupe}
              alt="Les fondateurs de la Villa Maria"
              className="w-full h-full object-cover"
            />
          </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="container-villa">
          <SectionTitle
            ...
            title="Quatre engagements."
          />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {VALEURS.map((v, i) => (
              <div key={v.title} className="bg-card p-7">
                <div className="text-accent font-display text-3xl mb-3">
                  0{i + 1}
                </div>
